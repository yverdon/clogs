    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="theme_interface", to="themes.interface"
                    ),
                ),
                (
                    "layergrouptreeitem",
                    models.ManyToManyField(
                        related_name="theme", to="themes.layergrouptreeitem"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.DO_NOTHING, to="themes.treegroup"
            ),
        ),
        migrations.CreateModel(
            name="Layergroup",
        ...
        migrations.AddField(
            ...
            name="treeitem",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.DO_NOTHING, to="themes.treeitem"
            ),
        ),
        migrations.AddField(
            model_name="layer",
