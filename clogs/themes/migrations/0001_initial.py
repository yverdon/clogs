    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_table', models.CharField(blank=True, null=True)),
                ('exclude_properties', models.CharField(blank=True, null=True)),
                ('interface', models.ManyToManyField(blank=True, to='themes.interface')),
                ('metadata', models.ManyToManyField(blank=True, related_name='layer_metadata', to='themes.metadata')),
            ],
            options={
                'verbose_name': 'Couche',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layer', models.ManyToManyField(blank=True, related_name='layergroupmp', to='themes.layer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matrix_set', models.CharField(blank=True, null=True)),
                ('image_type', models.CharField(max_length=10)),
                ('layer', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='layerwmts', to='themes.layer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layer', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='layerwms', to='themes.layer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordering', models.IntegerField()),
                ('public', models.BooleanField()),
                ('functionality', models.ManyToManyField(blank=True, to='themes.functionality')),
                ('group', models.ManyToManyField(blank=True, to='auth.group')),
                ('interface', models.ManyToManyField(blank=True, related_name='theme_interface', to='themes.interface')),
                ('layergroupmp', models.ManyToManyField(blank=True, related_name='theme_layergroupmp', to='themes.layergroupmp')),
                ('metadata', models.ManyToManyField(blank=True, related_name='theme_metadata', to='themes.metadata')),
            ],
            options={
                'verbose_name': 'Thème',
