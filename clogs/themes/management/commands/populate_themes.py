...
def create_layers():
    ...
    layer_wms = models.Layer.objects.create(
        name = "Layer WMS",
        public = True
    )
    ...
    layer_wtms = models.Layer.objects.create(
        name = "Layer WMTS Swisstopo",
        public = True
    )
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        print(
            f"👥 added demo themes, layer groups and layers for demo!"
        )
